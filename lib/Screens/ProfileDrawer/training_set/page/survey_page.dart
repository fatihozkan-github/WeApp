...
class _SurveyPageState extends State<SurveyPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Anket Sayfası'), centerTitle: true),
      body: isLoading
          ? WESpinKit()
          : Padding(
              ...
              child: showResult
                  ...
                  : Column(
                      children: [
                        Text(
                          'Soru ${currentQuestionIndex + 1} \\ ${surveys.length}',
                          ...
                          children: [
                            ...
                            if (userAnswer.keys.contains(currentQuestionIndex) || userCurrentAnswer != -1)
                              TextButton.icon(
                                  ...
                                  icon: RotatedBox(quarterTurns: 2, child: Icon(Icons.arrow_back_ios)),
                                  label: Text('${currentQuestionIndex == surveys.length - 1 ? 'Bitir' : 'İleri'}')),
                          ],
                        )
                      ],
                    ),
